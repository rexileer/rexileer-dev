...
DEFAULT_PROJECTS = [
    ...
    {"slug": "meat-bot", "meta_en": "Featured", "meta_ru": "Витрина",
     "title_en": "Production System for Meat Factory", "title_ru": "Производственная система для мясного завода",
     ...
     "tags": ["Aiogram", "Django", "PostgreSQL", "Docker Compose", "Minio", "openpyxl", "Redis"],
     "links": [{"type": "github", "href": "https://github.com/rexileer/meat-bot-example", "label": {"en": "GitHub", "ru": "GitHub"}}], "order": 2},
    {"slug": "freelance-bot", "meta_en": "Featured", "meta_ru": "Витрина",
     "title_en": "Freelance Bot", "title_ru": "Фриланс-бот",
     ...
     "links": [{"type": "github", "href": "https://github.com/rexileer/freelance-bot-demo", "label": {"en": "GitHub", "ru": "GitHub"}}], "order": 3},
    {"slug": "payment-broadcast-bot", "meta_en": "Featured", "meta_ru": "Витрина",
     "title_en": "Payment Broadcast Bot", "title_ru": "Бот для рассылки оплаты",
     ...
     "links": [{"type": "github", "href": "https://github.com/rexileer/payment-broadcast-bot-example", "label": {"en": "GitHub", "ru": "GitHub"}}], "order": 4},
    {"slug": "telegram-channel", "meta_en": "Telegram Channel", "meta_ru": "Телеграм-канал",
     "title_en": "Telegram Channel", "title_ru": "Телеграм-канал",
     ...
     "tags": ["Telegram"],
     "links": [{"type": "telegram", "href": "https://t.me/rexileerdev", "label": {"en": "Open channel", "ru": "Открыть канал"}}], "order": 5},
]
