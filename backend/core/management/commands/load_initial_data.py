...
DEFAULT_TEXTS = [
    ("brand.name", "en", "Rexileer"),
    ("brand.name", "ru", "Rexileer"),
    ("nav.about", "en", "About"),
    ("nav.about", "ru", "Обо мне"),
    ("nav.skills", "en", "Skills"),
    ("nav.skills", "ru", "Навыки"),
    ("nav.projects", "en", "Projects"),
    ("nav.projects", "ru", "Проекты"),
    ("nav.contact", "en", "Contact"),
    ("nav.contact", "ru", "Контакты"),
    ("langToggle.label", "en", "Language"),
    ("langToggle.label", "ru", "Язык"),
    ("hero.eyebrow", "en", "Backend Developer"),
    ("hero.eyebrow", "ru", "Бэкенд-разработчик"),
    ...
    (
        "hero.subtitle",
        "ru",
        "Проектирую и поддерживаю сервисы данных с фокусом на стабильность, наблюдаемость и быструю доставку фич.",
    ),
    ("hero.ctaProjects", "en", "See projects"),
    ("hero.ctaProjects", "ru", "Смотреть проекты"),
    ("hero.ctaContact", "en", "Let's connect"),
    ("hero.ctaContact", "ru", "Связаться"),
    ("about.eyebrow", "en", "Profile"),
    ("about.eyebrow", "ru", "Профиль"),
    ("about.title", "en", "Short intro"),
    ("about.title", "ru", "Коротко обо мне"),
    (
        "about.paragraph1",
        "en",
    ...
    ("skills.eyebrow", "en", "Stack"),
    ("skills.eyebrow", "ru", "Стек"),
    ("skills.title", "en", "Skills & tools"),
    ("skills.title", "ru", "Навыки и инструменты"),
    (
        "skills.description",
        "en",
    ...
    (
        "skills.description",
        "ru",
        "Работаю в экосистеме Python, создаю микросервисы и backend с Docker, Redis, Celery и CI/CD.",
    ),
    ("projects.eyebrow", "en", "Selected Work"),
    ("projects.eyebrow", "ru", "Избранное"),
    ("projects.title", "en", "Projects"),
    ("projects.title", "ru", "Проекты"),
    ("contact.eyebrow", "en", "Let's Talk"),
    ("contact.eyebrow", "ru", "На связи"),
    ("contact.title", "en", "Contact"),
    ("contact.title", "ru", "Контакты"),
    (
        "contact.description",
        "en",
    ...
    (
        "contact.description",
        "ru",
        "Доступен для удалённой работы (full-time / contract). Пишите, если нужен backend-инженер — обсудим объём и сроки.",
    ),
    ("contact.labels.email", "en", "Email"),
    ("contact.labels.email", "ru", "Email"),
    ("contact.labels.github", "en", "GitHub"),
    ("contact.labels.github", "ru", "GitHub"),
    ("contact.labels.linkedin", "en", "LinkedIn"),
    ("contact.labels.linkedin", "ru", "LinkedIn"),
    ("contact.labels.telegram", "en", "Telegram"),
    ("contact.labels.telegram", "ru", "Telegram"),
...
DEFAULT_PROJECTS = [
    {
        ...
        "meta_en": "Live Demo",
        "meta_ru": "Демо",
        "title_en": "Crypto Scalping MEXC",
        "title_ru": "Крипто скальпинг MEXC",
    ...
    },
    {
        ...
        "meta_en": "Featured",
        "meta_ru": "Витрина",
        "title_en": "Production System for Meat Factory",
        "title_ru": "Производственная система для мясного завода",
        "description_en": "Production system: Telegram bot (workshop) + Django CRM (office).",
        "description_ru": "Производственная система: Telegram‑бот (цех) + Django CRM (офис).",
        "tags": [
            "Aiogram",
            "Django",
            "PostgreSQL",
    ...
    },
    {
        ...
        "meta_en": "Featured",
        "meta_ru": "Витрина",
        "title_en": "Freelance Bot",
        "title_ru": "Фриланс-бот",
        "description_en": "Telegram bot for automating the search and placement of freelance applications.",
        "description_ru": "Телеграм-бот для автоматизации поиска и размещения фриланс-заявок.",
    ...
    {
        "slug": "payment-broadcast-bot",
        "meta_en": "Featured",
        "meta_ru": "Витрина",
        "title_en": "Payment Broadcast Bot",
        "title_ru": "Бот для рассылки оплаты",
        "description_en": "Bot for paid subscriptions/payments and mailings.",
        "description_ru": "Бот для платных подписок/платежей и рассылок.",
    ...
    },
    {
        ...
        "meta_en": "Telegram Channel",
        "meta_ru": "Телеграм-канал",
        "title_en": "Telegram Channel",
        "title_ru": "Телеграм-канал",
        "description_en": "Telegram channel about my experience in various projects.",
        "description_ru": "Телеграм-канал, в котором подробно описывается мой опыт в различных проектах.",
        "tags": ["Telegram"],
        "links": [
            {
                "type": "telegram",
